...
def run_simulation(sampling_alg, decay_factor, noise_level, adaptive_decay=False, overtraining=False, iterations=10):
                ...
                if overtraining:
                    ...
                    if overtraining_count >= overtraining_threshold:
                        ...
                        if rule_index < len(rules):
                            current_rule = rules[rule_index]
                            #print(f'Rule switched to {current_rule}')
                            consecutive_correct = 0
                            learnt_rule = False
                        else:
    ...
    output_csv_path = "BayesianRLCode/data/simulation_df.csv"
