...
def plotLearningCurves(decay_factors, noise_levels, sampling_alg, simulation_dfs):
    ...
    for training in simulation_dfs.keys():
        ...
        # find stats for fastest normally trained and over-trained agent
    ...
    plt.savefig("BayesianRLCode/images/learning_curves.pdf", format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
def plotCumulativeDistributions(decay_factors, noise_levels, sampling_alg, simulation_dfs):
    ...
    plt.tight_layout()
    plt.savefig("BayesianRLCode/images/cumdistributions.pdf", format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
def plotMAPProbabilities(decay_factors, noise_levels, sampling_alg, simulation_dfs):
    ...
    plt.tight_layout()
    plt.savefig("BayesianRLCode/images/MAPprob.pdf", format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
def plotTotalCorrect(decay_factors, noise_levels, sampling_alg, simulation_dfs):
    ...
    plt.savefig("BayesianRLCode/images/totalCorrect.pdf", format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
def plotStatistics(unfiltered_data):
    ...
    plt.tight_layout()  
    plt.savefig("BayesianRLCode/images/statisticsplot.pdf", format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
