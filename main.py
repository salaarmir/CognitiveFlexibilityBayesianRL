...
output_csv_path = "data/unfiltered_results.csv"

unfiltered_data.to_csv(output_csv_path, index=False)

# export results df to csv
output_csv_path = "data/filtered_results.csv"
...
createPlots.plotCumulativeDistributions(decay_factors, noise_levels, sample_alg, simulation_dfs_dict['overtrained'])
